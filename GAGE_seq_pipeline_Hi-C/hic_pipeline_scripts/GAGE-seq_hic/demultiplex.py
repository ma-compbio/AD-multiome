...
def process(wellID_list, barcode1_list, barcode2_list, pos1_list, pos2_list, mode_list, in_handles, out_handles, out_handles_u, barcode2keep,):
	K = len(mode_list)
	num_total = 0
...
def parseArgument():
	parser = argparse.ArgumentParser(description = 'Example %(prog)s -h', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
