...
def main():
    ...
    create_index_html_pretty(json_files, index_file)


def create_index_html(json_files, index_file):
    """
    Create an index.html file to link all json files and show a summary of clinical trials
    """
    index_content = """
    ...
    for json_file in json_files:
        ...
        index_content += f"""
            <tr>
                ...
                <td style="max-width:300px; white-space:pre-wrap; word-wrap:break-word;" title="{trial_description}">{trial_title}</td>
                ...
                <td style="max-width:160px; white-space:pre-wrap; word-wrap:break-word;" title="{trial_explanation_agent}">{trial_agent_type}</td>
...
def create_index_html_pretty(json_files, index_file):
    index_content = """
    <html>
    <head>
        <title>Clinical Trials Summary</title>
